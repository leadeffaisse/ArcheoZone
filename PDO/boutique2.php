...
try {
    $mysqlClient = new PDO('mysql:host=localhost;dbname=boutique;charset=utf8', 'business', 'motdepasse');
    ...
    <div class="container">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            <?php foreach ($products as $product):
                include('templates/product-card2.php');
            endforeach;
            ?>
        </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="ficheProduitLabel<?php echo $product['id']; ?>"><?php echo $product['name']; ?></h5>
                                ...
                                <div class="col-xs-12 col-sm-7 col-md-7">
                                    ...
                                    <?php if (!empty($product['discount']) && ($product['discount']) > 0): ?>
                                        <div class="btn-group btn-group-sm m-2" role="group" aria-label="Small button group">
                                            ...
                                            <button type="button" class="btn btn-outline-primary"><s><?php echo formatPrice($product['price'], 2, ',', ' '); ?></s></button>
                                        </div>
                                    <?php endif; ?>
                                    <h2><strong><?php echo discountedprice($product['price'], $product['discount']); ?></strong></h2>
