<div class="col">
    <div class="card shadow-sm d-flex flex-column h-100">
        <img class="img-fluid" style="height: 400px; object-fit: cover;" src="<?php echo $product['imageURL']; ?>" alt="<?php echo $product['name']; ?>">
        <div class="card-body d-flex justify-content-between flex-column align-items-center">
            ...
            <div class="d-flex flex-column align-items-center">
                ...
                <div class="d-flex gap-2">
                    <h4><strong><?php echo discountedprice($product['price'], $product['discount']); ?></strong></h4>
                    <p class="fw-lighter"><?php echo pricexcludingVAT($product['price'], $product['discount']); ?> HT</p>
                </div>
